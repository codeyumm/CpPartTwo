...
namespace CpPartOne.Controllers
{
    public class StudentDataController : ApiController
    {
        ...
        /// <returns>
        /// A student object containing info of student
        /// </returns>
        ...
        /// Returns a student of a givent id
        /// </summary>
        /// <param name="searchInput">student name which is user input</param>
        /// <example>GET api/studentdata/searchStudent/{searchInput}</example>
        /// <returns>
        /// student object
        /// </returns>

        [HttpGet]
        [Route("api/studentdata/searchStudent/{searchInput}")]
        public IEnumerable<Student> SearchStudent(string searchInput)
        {
                ...
                cmd.CommandText =
                    "SELECT * FROM students WHERE studentfname LIKE @key OR studentlname LIKE @key OR studentnumber LIKE @key OR enroldate LIKE @key;";
...
/// view with input field to add
/// controller to get all the data that users have entered
/// data controller to execute the insert query 
/// 
/// for delete funtionality
/// create one button for delet in article list
/// we can pass the id of article in controller
/// create data controller to execute delete query